...
package com.bot.insta.components.mvvm.viewmodel
...
import com.bot.insta.components.mvvm.fragment.ViewModelStore
...
object ViewModelProvider {
    ...
    private fun <V: ViewModel> get(key: String?, modelClass: Class<V>) : ViewModel {
