package com.bot.insta.data.variables

object AppValues {

    const val API_URL = "https://i.instagram.com/api/v1/"

    const val API_KEY = "5e3d8912bec91f7cf6a2bcad8215a920"

    const val APP_ID = "2467274790268052"

    const val API_KEY_VERSION = "1"

    const val DEVICE_MANUFACTURER = "oneplus"

    const val DEVICE_MODEL = "7 pro"

    const val DEVICE_ANDROID_VERSION = "29"

    const val DEVICE_ANDROID_RELEASE = "10.0"

    const val HASH = "HASH"

    const val DEFAULT_HASH = "money"

    const val LIST = "LIST"


    var screenDimensions = arrayOf(0,0)

    const val DEFAULT_LIST = "brodywear"

    var currentAccount: String = ""

    const val DEVICE_EXPERIMENTS =
    ...
    val USER_AGENT = String.format(
        "Instagram 10.26.0 Android (%s/%s; 640dpi; 1440x2560; %s; %s; hero2lte; samsungexynos8890; en_US)",
